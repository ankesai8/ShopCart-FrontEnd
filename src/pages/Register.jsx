...
export default function Register() {
    ...
    const signInSchema=YUP.object().shape({
        ...
        password:YUP.string().required("Please Enter Password").min(6,"Password length should be more than 5"),
                ...
                <FormContainer>
                    ...
                    <Formik
                        ...
                        onSubmit={async(values,{resetForm})=>{
                            ...
                            const res=await axios.post("https://makeyouup-server.herokuapp.com/auth/register",other)
                            console.log(res)
                            setInfo("User created Successfully,Please Login with your Email/Password ")
                            setLoading(false)
                            }
                            catch(err)
                            {
                        ...
                        {()=>{
                            ...
                            <div className="form-group">
                            <Input type="password" placeholder="Confirm Password" className="form-control" id="confirmPassword" name="confirmPassword" />
